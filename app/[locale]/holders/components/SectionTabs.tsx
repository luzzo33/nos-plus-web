...
import { Eye, LineChart, Clock, BarChart3, Activity, PieChart, Crown } from 'lucide-react';
...
const baseSections = [
  ...
  { id: 'richlist', icon: Crown },
  { id: 'distribution', icon: PieChart },
];

export function SectionTabs({ activeSection, onSectionChange, isMobile }: SectionTabsProps) {
  const { text } = useFontScale();
  const t = useTranslations('holders.sections');
