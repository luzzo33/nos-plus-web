...
const STORAGE_PREFIX = 'analysis-locale-notice-v1';

export function AnalysisLocaleNotice() {
  const locale = useLocale() as Locale;

  return <AnalysisLocaleNoticeContent locale={locale} />;
}

function AnalysisLocaleNoticeContent({ locale }: { locale: Locale }) {
  const t = useTranslations('analysis.localeNotice');
      ...
      <div className="relative z-10 w-full max-w-sm rounded-xl border border-border bg-background p-6 shadow-2xl">
        <div className="flex flex-col items-center gap-4 text-center">
          ...
          <div className="space-y-3">
            ...
            <div className="flex items-start gap-2 rounded-lg border border-destructive/30 bg-destructive/10 px-3 py-2 text-left">
